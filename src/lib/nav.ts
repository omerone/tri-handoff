...
export const NAV: readonly NavDefinition[] = [
  ...
  { key: 'analytics', href: '/analytics', label: 'analytics', enabled: false }, // M1.5
  { key: 'trades', href: '/trades', label: 'trades', enabled: false }, // M1.6
  { key: 'calendar', href: '/calendar', label: 'calendar', enabled: false }, // M1.7
